...
Let's also look at how positive words are related to shares and number of images in an article. The scatter plot below shows the number of positive words in an article, colored by the number of images contained in the article.  
